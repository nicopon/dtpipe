...
rm -f "$ARTIFACTS_DIR/ref1_10k.csv"
rm -f "$ARTIFACTS_DIR/ref2_10k.csv"
...
echo "Generating ref1_10k.csv (10,000 rows)..."
"$DTPIPE_CMD" -i generate:10k --compute "Id:long:row.GenerateIndex" -o "csv:$ARTIFACTS_DIR/ref1_10k.csv" --no-stats

# 3. Reference 2 (10,000 rows)
echo "Generating ref2_10k.csv (10,000 rows)..."
"$DTPIPE_CMD" -i generate:10k --compute "Id:long:row.GenerateIndex" -o "csv:$ARTIFACTS_DIR/ref2_10k.csv" --no-stats
