...
## One source, an ordered chain, one target
...
See [DAG pipelines](guides/dag.md) for what branches make possible.
...
the same branch definitions, written down.
