...
public class FilterDataTransformer : IDataTransformer, IRequiresOptions<DtPipe.Transformers.Row.Filter.FilterTransformerOptions>
{
	private readonly DtPipe.Transformers.Row.Filter.FilterTransformerOptions _options;
	private readonly IJsEngineProvider _jsEngineProvider;
	private readonly List<JsValue> _compiledFilters = new();

	public FilterDataTransformer(DtPipe.Transformers.Row.Filter.FilterTransformerOptions options, IJsEngineProvider jsEngineProvider)
	{
		_options = options;
