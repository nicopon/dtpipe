...
/// </summary>
public class MaskDataTransformer : IDataTransformer, IRequiresOptions<DtPipe.Transformers.Row.Mask.MaskOptions>
{
	...
	public MaskDataTransformer(DtPipe.Transformers.Row.Mask.MaskOptions options)
	{
