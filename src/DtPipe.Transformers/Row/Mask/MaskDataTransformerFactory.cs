...
namespace DtPipe.Transformers.Row.Mask;
...
public class MaskDataTransformerFactory(OptionsRegistry registry) : IMaskDataTransformerFactory
{
	...
	public Type OptionsType => typeof(DtPipe.Transformers.Row.Mask.MaskOptions);

	public IDataTransformer CreateFromOptions(DtPipe.Transformers.Row.Mask.MaskOptions options)
	{
	...
	public IDataTransformer CreateFromConfiguration(IEnumerable<(string Option, string Value)> configuration)
	{
		...
		var options = new DtPipe.Transformers.Row.Mask.MaskOptions
		{
