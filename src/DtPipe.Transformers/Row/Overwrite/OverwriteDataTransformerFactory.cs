...
namespace DtPipe.Transformers.Row.Overwrite;
...
public class OverwriteDataTransformerFactory : IOverwriteDataTransformerFactory
{
	...
	public Type OptionsType => typeof(DtPipe.Transformers.Row.Overwrite.OverwriteOptions);
	...
	public IDataTransformer CreateFromConfiguration(IEnumerable<(string Option, string Value)> configuration)
	{
		...
		var options = new DtPipe.Transformers.Row.Overwrite.OverwriteOptions
		{
	...
	public IDataTransformer? CreateFromYamlConfig(TransformerConfig config)
	{
		...
		var options = new DtPipe.Transformers.Row.Overwrite.OverwriteOptions { Overwrite = mappings, SkipNull = skipNull };
		return new OverwriteDataTransformer(options);
	}
}
