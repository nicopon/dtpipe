...
public class WindowDataTransformer : IMultiRowTransformer, IRequiresOptions<DtPipe.Transformers.Row.Window.WindowOptions>
{
	private readonly DtPipe.Transformers.Row.Window.WindowOptions _options;
	...
	public WindowDataTransformer(DtPipe.Transformers.Row.Window.WindowOptions options, IJsEngineProvider jsEngineProvider)
	{
		_options = options;
