...
public sealed partial class FormatDataTransformer : IDataTransformer, IRequiresOptions<DtPipe.Transformers.Row.Format.FormatOptions>
{
	...
	public FormatDataTransformer(DtPipe.Transformers.Row.Format.FormatOptions options)
	{
