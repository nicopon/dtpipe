...
namespace DtPipe.Transformers.Row.Format;
...
public class FormatDataTransformerFactory(OptionsRegistry registry) : IFormatDataTransformerFactory
{
	...
	public Type OptionsType => typeof(DtPipe.Transformers.Row.Format.FormatOptions);

	public IDataTransformer CreateFromOptions(DtPipe.Transformers.Row.Format.FormatOptions options)
	{
	...
	public IDataTransformer CreateFromConfiguration(IEnumerable<(string Option, string Value)> configuration)
	{
		...
		var registryOptions = _registry.Get<DtPipe.Transformers.Row.Format.FormatOptions>();

		var options = new DtPipe.Transformers.Row.Format.FormatOptions
		{
