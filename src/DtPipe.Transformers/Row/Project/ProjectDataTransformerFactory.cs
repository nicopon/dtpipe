...
public class ProjectDataTransformerFactory(OptionsRegistry registry) : IDataTransformerFactory
{
	...
	public Type OptionsType => typeof(DtPipe.Transformers.Row.Project.ProjectOptions);

	public IDataTransformer CreateFromOptions(DtPipe.Transformers.Row.Project.ProjectOptions options)
	{
