...
namespace DtPipe.Transformers.Row.Project;

/// <summary>
/// Selects (Project) or Drops specific columns.
/// </summary>
public class ProjectDataTransformer : IColumnarTransformer, IRequiresOptions<DtPipe.Transformers.Row.Project.ProjectOptions>
{
	...
	public ProjectDataTransformer(DtPipe.Transformers.Row.Project.ProjectOptions options)
	{
