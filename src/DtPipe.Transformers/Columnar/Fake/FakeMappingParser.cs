...
{
	private readonly DtPipe.Transformers.Columnar.Fake.FakerRegistry _registry;
	...
	public FakeMappingParser(DtPipe.Transformers.Columnar.Fake.FakerRegistry registry)
	{
		_registry = registry;
	}
