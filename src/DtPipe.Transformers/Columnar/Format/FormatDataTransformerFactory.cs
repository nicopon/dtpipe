...
public class FormatDataTransformerFactory(OptionsRegistry registry) : IDataTransformerFactory
{
	...
	public Type OptionsType => typeof(DtPipe.Transformers.Columnar.Format.FormatOptions);

	public IDataTransformer CreateFromOptions(DtPipe.Transformers.Columnar.Format.FormatOptions options)
	{
	...
	public IDataTransformer CreateFromConfiguration(IEnumerable<(string Option, string Value)> configuration)
	{
		...
		var registryOptions = _registry.Get<DtPipe.Transformers.Columnar.Format.FormatOptions>();

		var options = new DtPipe.Transformers.Columnar.Format.FormatOptions
		{
