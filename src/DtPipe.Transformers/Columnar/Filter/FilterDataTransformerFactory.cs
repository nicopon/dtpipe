...
public class FilterDataTransformerFactory : IDataTransformerFactory
{
	...
	public Type OptionsType => typeof(DtPipe.Transformers.Columnar.Filter.FilterTransformerOptions);
	...
	public IDataTransformer CreateFromOptions(DtPipe.Transformers.Columnar.Filter.FilterTransformerOptions options)
	{
	...
	public IDataTransformer CreateFromConfiguration(IEnumerable<(string Option, string Value)> configuration)
	{
		...
		var options = new DtPipe.Transformers.Columnar.Filter.FilterTransformerOptions { Filters = filters.ToArray() };
		return new FilterDataTransformer(options, _jsEngineProvider);
	}
	...
	public IDataTransformer? CreateFromYamlConfig(TransformerConfig config)
	{
		...
		return new FilterDataTransformer(new DtPipe.Transformers.Columnar.Filter.FilterTransformerOptions { Filters = filters.ToArray() }, _jsEngineProvider);
	}
}
