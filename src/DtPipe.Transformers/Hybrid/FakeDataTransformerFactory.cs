...
public class FakeDataTransformerFactory : IFakeDataTransformerFactory
{
	...
	public Type OptionsType => typeof(DtPipe.Transformers.Hybrid.Fake.FakeOptions);

	public IDataTransformer CreateFromConfiguration(IEnumerable<(string Option, string Value)> configuration)
	{
		var globalOptions = _registry.Get<DtPipe.Transformers.Hybrid.Fake.FakeOptions>();
		...
		var options = new DtPipe.Transformers.Hybrid.Fake.FakeOptions
		{
			Fake = mappings,
			Locale = locale,
			Seed = seed,
	...
	public IDataTransformer CreateFromOptions(DtPipe.Transformers.Hybrid.Fake.FakeOptions options)
	{
		return new FakeDataTransformer(options);
	}
	...
	public IDataTransformer? CreateFromYamlConfig(TransformerConfig config)
	{
		...
		var options = new DtPipe.Transformers.Hybrid.Fake.FakeOptions { Fake = mappings };
