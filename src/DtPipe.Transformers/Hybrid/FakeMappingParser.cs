...
{
	private readonly DtPipe.Transformers.Hybrid.Fake.FakerRegistry _registry;
	...
	public FakeMappingParser(DtPipe.Transformers.Hybrid.Fake.FakerRegistry registry)
	{
		_registry = registry;
	}
