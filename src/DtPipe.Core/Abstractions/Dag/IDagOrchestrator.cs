...
public interface IDagOrchestrator
{
    ...
    Task<int> ExecuteAsync(JobDagDefinition dag, Func<BranchDefinition, BranchChannelContext, CancellationToken, Task<int>> branchExecutor, CancellationToken cancellationToken = default);
