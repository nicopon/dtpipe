...
public interface IDagOrchestrator
{
    ...
    Task<int> ExecuteAsync(JobDagDefinition dag, Func<BranchDefinition, CancellationToken, Task<int>> branchExecutor, CancellationToken cancellationToken = default);
