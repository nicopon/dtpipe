...
public static class CliPipelineRules
{
    ...
    /// <summary>
    /// Phase 1: Options available after an input/xstreamer is defined but before an output.
    /// </summary>
    ...
    /// <summary>
    /// Flags that are sources but typically used within an XStreamer branch.
    /// </summary>
    ...
    /// <summary>
    /// Flags that define a new branch or an XStreamer junction.
    /// </summary>
    public static readonly HashSet<string> XStreamerFlags = new(StringComparer.OrdinalIgnoreCase) { "-x", "--xstreamer" };
